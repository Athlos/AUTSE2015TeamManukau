...
<body>
	<h1>SERLER Prototype</h1>
	<?php
	require_once ("InstallDatabases.php");
	?>
	<form>
	<a href="Useraccountcreation/useraccountform.php">Make Account</a><br>
	<a href="Paper Submission and Withdrawl/temp.php">Submit or Withdraw Papers</a><br>
	<a href="moderate_papers/view_papers.php">Moderate Papers</a><br>
