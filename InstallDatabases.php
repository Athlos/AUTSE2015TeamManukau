...
<body>
	<?php
		...
		//created the approved user accounts list
		...
		//will print only if the approved accounts list cannot be created
		if ($conn->query($query) === FALSE)
		echo "approved user accounts list failed to created";
